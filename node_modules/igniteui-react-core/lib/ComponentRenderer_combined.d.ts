...
export declare class ComponentRenderer extends Base {
    static $t: Type;
    e: IComponentRendererAdapter;
    private _context;
    context: TypeDescriptionContext;
    private _isProceedOnErrorEnabled;
    isProceedOnErrorEnabled: boolean;
    g: ITypeDescriptionPropertyTransforms;
    h: TypeDescriptionCleanups;
    ...
    protected aj(): boolean;
    private cj;
    provideRefValueFromJson(a: any, b: string, c: string): void;
    protected a3(): (arg1: string) => string;
    z(a: JsonDictionaryItem): boolean;
    y(a: JsonDictionaryItem): boolean;
    ...
    private an;
    private au;
    readonly ay: Dictionary$2<any, ContainerState>;
    private as;
    private am;
    private at;
    private av;
    ...
    private bf;
    private be;
    c(a: string, b: ContainerState): DescriptionRef;
    private bu;
    private bd;
    private bt;
    private bb;
    ...
    cp(a: any, b: string, c: any, d: boolean): void;
    removeRefValueCore(a: any, b: string, c: boolean): void;
    clearUserRefValues(): void;
    p(a: DescriptionRef): boolean;
    bq(a: DescriptionRef): any;
    o(a: string): boolean;
    d(a: string): DescriptionRef;
    ...
    private c3;
    private ag;
    cd(a: any, b: any, c: ContainerState): void;
    private a4;
    private aa;
    private cr;
    private af;
