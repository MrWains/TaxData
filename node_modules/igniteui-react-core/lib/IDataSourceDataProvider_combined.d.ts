...
export declare abstract class BaseDataSource extends Base implements IDataSource, IEditableDataSource {
    ...
    private cn;
    protected cm(a: TransactionEvent, b: any): void;
    ...
    protected by(a: number, b: DataSourceAggregatedResult[]): void;
    static a9(a: string): string;
    private cr;
    private bv;
    private cs;
    private bt;
    ...
    protected a0(a: any, b: string): any;
    protected am(a: any, b: string): boolean;
    getItemPropertyAtIndex(a: number, b: string): any;
