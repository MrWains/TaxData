...
var FunctionFilterExpressionDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FunctionFilterExpressionDescriptionMetadata.c = function (a, b) {
        ...
        b.item("FunctionType@names", "Contains;EndsWith;StartsWith;Length;IndexOf;Replace;Substring;ToLower;ToUpper;Trim;Concat;Day;Hour;Minute;Month;Second;Year;Round;Floor;Ceiling;Date;Time;Now;IsOf;Cast");
    ...
    FunctionFilterExpressionDescriptionMetadata.d = function (a) {
        ...
        a.q("FunctionFilterExpression", function () { return new FunctionFilterExpressionDescription(); });
        a.p("FunctionFilterExpression", FunctionFilterExpressionDescriptionMetadata.a);
    };
