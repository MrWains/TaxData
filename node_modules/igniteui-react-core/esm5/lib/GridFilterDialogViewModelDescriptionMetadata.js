...
var GridFilterDialogViewModelDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridFilterDialogViewModelDescriptionMetadata.c = function (a, b) {
        ...
        b.item("PropertyType@names", "StringValue;IntValue;BooleanValue;LongValue;ShortValue;DoubleValue;DecimalValue;SingleValue;DateTimeValue;DateTimeOffsetValue;ByteValue;ObjectValue");
        b.item("IsTopLevelOr", "Boolean");
        b.item("MaxGroupingLevels", "Number:int");
        b.item("Rows", "Collection:GridFilterDialogViewModelRow:GridFilterDialogViewModelRowCollection:GridFilterDialogViewModelRow");
    };
    GridFilterDialogViewModelDescriptionMetadata.d = function (a) {
        GridFilterDialogViewModelDescriptionMetadata.b(a);
        a.q("GridFilterDialogViewModel", function () { return new GridFilterDialogViewModelDescription(); });
        a.p("GridFilterDialogViewModel", GridFilterDialogViewModelDescriptionMetadata.a);
    };
