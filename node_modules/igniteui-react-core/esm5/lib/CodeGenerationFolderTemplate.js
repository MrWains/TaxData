...
var CodeGenerationFolderTemplate = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(CodeGenerationFolderTemplate, _super);
    ...
    CodeGenerationFolderTemplate.prototype.execute = function (a) {
        ...
        try {
            for (var _c = tslib_1.__values(fromEnum(a.getNewFiles())), _d = _c.next(); !_d.done; _d = _c.next()) {
                var ac = _d.value;
                var ad = a.getNewFileContent(ac);
                var ae = "";
                try {
                    for (var _e = (e_2 = void 0, tslib_1.__values(fromEnum(this.d))), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var af = _f.value;
    ...
    CodeGenerationFolderTemplate.prototype.j = function (a, b, c) {
        ...
        var _loop_1 = function (f) {
            ...
            a = g.b(a, function (h, i, j) {
                ...
                try {
                    for (var _b = (e_4 = void 0, tslib_1.__values(fromEnum(k))), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var m = _c.value;
