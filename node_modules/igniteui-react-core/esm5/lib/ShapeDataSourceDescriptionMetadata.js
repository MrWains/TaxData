...
var ShapeDataSourceDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ShapeDataSourceDescriptionMetadata, _super);
    ...
    ShapeDataSourceDescriptionMetadata.b = function (a) {
        if (ShapeDataSourceDescriptionMetadata.a == null) {
            ...
            ShapeDataSourceDescriptionMetadata.c(a, ShapeDataSourceDescriptionMetadata.a);
            AsyncCompletedEventArgsDescriptionMetadata.d(a);
            ShapeFilterRecordEventArgsDescriptionMetadata.d(a);
        }
    };
    ShapeDataSourceDescriptionMetadata.c = function (a, b) {
        b.item("WorldRect", "Rect");
        b.item("ComputedWorldRect", "Rect");
        b.item("DeferImportCompleted", "Boolean");
        b.item("ShapefileSource", "String");
        b.item("DatabaseSource", "String");
        b.item("ImportPendingRef", "EventRef::importPending");
        b.item("ImportCompletedRef", "EventRef::importCompleted");
        b.item("FilterRef", "EventRef::filter");
    };
    ShapeDataSourceDescriptionMetadata.d = function (a) {
        ShapeDataSourceDescriptionMetadata.b(a);
        a.q("ShapeDataSource", function () { return new ShapeDataSourceDescription(); });
        a.p("ShapeDataSource", ShapeDataSourceDescriptionMetadata.a);
    };
