...
var CellInfoDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CellInfoDescriptionMetadata.c = function (a, b) {
        ...
        b.item("HoverStatus", "Number:double");
        b.item("HorizontalAlignment", "ExportedType:string:CellContentHorizontalAlignment");
        b.item("HorizontalAlignment@names", "Left;Center;Right;Stretch;Auto");
        b.item("VerticalAlignment", "ExportedType:string:CellContentVerticalAlignment");
        b.item("VerticalAlignment@names", "Top;Center;Bottom;Stretch;Auto");
        ...
        b.item("LineBreakMode@names", "Ellipsis;NoWrap;WordWrap;CharacterWrap");
