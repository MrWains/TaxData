...
var CodeGeneratingImportManager = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(CodeGeneratingImportManager, _super);
    function CodeGeneratingImportManager() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._isImportsOnly = false;
        _this.i = new List$1(String_$type, 0);
        _this.g = new HashSet$1(String_$type, 0);
        _this.h = new List$1(String_$type, 0);
        _this.e = new Dictionary$2(String_$type, List$1.$.specialize(String_$type), 0);
        _this.f = new Dictionary$2(String_$type, HashSet$1.$.specialize(String_$type), 0);
        return _this;
    }
    ...
    CodeGeneratingImportManager.merge = function (a, b) {
        ...
        if (b.e.count > 0 || a.e.count > 0) {
            try {
                for (var _g = tslib_1.__values(fromEnum(a.e.keys)), _h = _g.next(); !_h.done; _h = _g.next()) {
                    var d = _h.value;
                    try {
                        for (var _j = (e_2 = void 0, tslib_1.__values(fromEnum(a.e.item(d)))), _k = _j.next(); !_k.done; _k = _j.next()) {
                            var e = _k.value;
            ...
            try {
                for (var _l = tslib_1.__values(fromEnum(b.e.keys)), _m = _l.next(); !_m.done; _m = _l.next()) {
                    var f = _m.value;
                    try {
                        for (var _o = (e_4 = void 0, tslib_1.__values(fromEnum(b.e.item(f)))), _p = _o.next(); !_p.done; _p = _o.next()) {
                            var g = _p.value;
            ...
            try {
                for (var _q = tslib_1.__values(fromEnum(a.i)), _r = _q.next(); !_r.done; _r = _q.next()) {
                    var h = _r.value;
                    c.addUsing(h);
                }
            }
            ...
            try {
                for (var _s = tslib_1.__values(fromEnum(b.i)), _t = _s.next(); !_t.done; _t = _s.next()) {
                    var i = _t.value;
                    c.addUsing(i);
                }
            }
    ...
    CodeGeneratingImportManager.prototype.removeDuplicates = function (a) {
        ...
        if (a.e.count > 0) {
            try {
                for (var _d = tslib_1.__values(fromEnum(a.e.keys)), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var c = _e.value;
                    if (this.e.containsKey(c)) {
                        try {
                            for (var _f = (e_8 = void 0, tslib_1.__values(fromEnum(a.e.item(c)))), _g = _f.next(); !_g.done; _g = _f.next()) {
                                var d = _g.value;
            ...
            try {
                for (var _h = tslib_1.__values(fromEnum(a.i)), _j = _h.next(); !_j.done; _j = _h.next()) {
                    var e = _j.value;
                    if (b.g.contains(e)) {
                        b.g.remove(e);
                        b.i.remove(e);
