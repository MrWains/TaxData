...
var GeographicMapDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GeographicMapDescriptionMetadata.c = function (a, b) {
        ...
        b.item("ResizeBehavior@names", "Auto;MaintainTopLeftPosition;MaintainCenterPosition");
        b.item("IsHorizontalWrappingEnabled", "Boolean");
        b.item("BackgroundTilingMode", "ExportedType:string:MapBackgroundTilingMode");
        b.item("BackgroundTilingMode@names", "Auto;NonWrapped;Wrapped");
    ...
    GeographicMapDescriptionMetadata.d = function (a) {
        ...
        a.q("GeographicMap", function () { return new GeographicMapDescription(); });
        a.p("GeographicMap", GeographicMapDescriptionMetadata.a);
    };
...
var GeographicMapImageryDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GeographicMapImageryDescriptionMetadata.d = function (a) {
        ...
        a.p("GeographicMapImagery", GeographicMapImageryDescriptionMetadata.a);
    };
