 ...
 * @hidden
 */
var TreemapDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(TreemapDescriptionMetadata, _super);
    function TreemapDescriptionMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TreemapDescriptionMetadata.b = function (a) {
    ...
    TreemapDescriptionMetadata.c = function (a, b) {
        ...
        b.item("FillScaleMode@names", "Sum;GlobalSum;Value;GlobalValue");
        ...
        b.item("LabelVerticalFitMode@names", "Auto;Show;Hide");
        b.item("LabelHorizontalFitMode", "ExportedType:string:TreemapLabelHorizontalFitMode");
        b.item("LabelHorizontalFitMode@names", "Auto;Ellipsis;Hide");
        ...
        b.item("HeaderDisplayMode@names", "Auto;Header;Overlay");
        ...
        b.item("LayoutOrientation@names", "Horizontal;Vertical");
        b.item("LayoutType", "ExportedType:string:TreemapLayoutType");
        b.item("LayoutType@names", "Squarified;SliceAndDice;Stripped");
    ...
    TreemapDescriptionMetadata.d = function (a) {
        TreemapDescriptionMetadata.b(a);
        a.q("Treemap", function () { return new TreemapDescription(); });
        a.p("Treemap", TreemapDescriptionMetadata.a);
    };
    TreemapDescriptionMetadata.e = function (a, b) {
    ...
    TreemapDescriptionMetadata.$t = markType(TreemapDescriptionMetadata, 'TreemapDescriptionMetadata');
    TreemapDescriptionMetadata.a = null;
    return TreemapDescriptionMetadata;
}(Base));
export { TreemapDescriptionMetadata };
