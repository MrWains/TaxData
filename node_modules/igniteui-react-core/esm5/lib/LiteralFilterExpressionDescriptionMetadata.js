 ...
 * @hidden
 */
var LiteralFilterExpressionDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(LiteralFilterExpressionDescriptionMetadata, _super);
    function LiteralFilterExpressionDescriptionMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LiteralFilterExpressionDescriptionMetadata.b = function (a) {
    ...
    LiteralFilterExpressionDescriptionMetadata.c = function (a, b) {
        FilterExpressionDescriptionMetadata.c(a, b);
        b.item("LiteralValue", "Unknown");
        b.item("LeaveUnquoted", "Boolean");
    };
    LiteralFilterExpressionDescriptionMetadata.d = function (a) {
        LiteralFilterExpressionDescriptionMetadata.b(a);
        a.q("LiteralFilterExpression", function () { return new LiteralFilterExpressionDescription(); });
        a.p("LiteralFilterExpression", LiteralFilterExpressionDescriptionMetadata.a);
    };
    ...
    return LiteralFilterExpressionDescriptionMetadata;
}(Base));
export { LiteralFilterExpressionDescriptionMetadata };
