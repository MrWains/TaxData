...
var VirtualDataSource = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function VirtualDataSource() {
        ...
        _this.cv = null;
        _this.cw = null;
        _this.dd = new LRUCache$2(Base.$, IDataSourcePage_$type, 0, 200);
        _this.dk = new Dictionary$2(Base.$, Array_$type, 0);
        _this.dl = new Dictionary$2(Number_$type, Number_$type, 0);
        _this.df = false;
        _this.ct = null;
        _this.cy = null;
        _this.dc = new SectionMap();
        _this.cu = null;
        _this.dv = -1;
        _this.dn = -1;
        _this.dx = -1;
        ...
        _this.ds = -1;
        _this.du = -1;
        _this.dj = new Dictionary$2(String_$type, Boolean_$type, 0);
        _this._concurrencyTag = null;
        _this.batchStarted = null;
        _this.batchCompleted = null;
        _this.da = new PagePredictionEngine();
        _this.da.e = _this;
        _this.da.ag = _this.actualPageSize;
        _this.da.f = _this.dc;
        _this.executionContext = new DataSourceExecutionContext();
        _this.da.b = _this.executionContext;
    ...
    Object.defineProperty(VirtualDataSource.prototype, "dataProvider", {
        ...
        set: function (a) {
            ...
            this.c1 = a;
            if (b != this.c1) {
                this.onPropertyUpdated("DataProvider", b, this.c1);
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(VirtualDataSource.prototype, "actualDataProvider", {
        ...
        set: function (a) {
            ...
            this.c0 = a;
            if (b != this.c0) {
                this.onPropertyUpdated("ActualDataProvider", b, this.c0);
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(VirtualDataSource.prototype, "pageSizeRequested", {
        ...
        set: function (a) {
            ...
            this.d2 = a;
            if (b != this.d2) {
                this.onPropertyUpdated("PageSizeRequested", b, this.d2);
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(VirtualDataSource.prototype, "maxCachedPages", {
        ...
        set: function (a) {
            ...
            this.d1 = a;
            if (b != this.d1) {
                this.onPropertyUpdated("MaxCachedPages", b, this.d1);
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(VirtualDataSource.prototype, "actualPageSize", {
        ...
        set: function (a) {
            ...
            this.dm = a;
            if (b != this.dm) {
                this.onPropertyUpdated("ActualPageSize", b, this.dm);
            }
        },
        enumerable: true,
        configurable: true
    ...
    VirtualDataSource.prototype.get_isSortingSupported = function () {
        if (this.externalDataSource != null && !this.de) {
            this.de = true;
    ...
    Object.defineProperty(VirtualDataSource.prototype, "c6", {
        get: function () {
            return this.c5;
        },
        set: function (a) {
    ...
    VirtualDataSource.prototype.resolveDataProvider = function () {
        ...
        return this.c6.resolveDataProvider();
    };
    VirtualDataSource.prototype.propertyUpdatedOverride = function (a, b, c) {
        ...
        switch (a) {
            ...
            case "ExecutionContext":
                this.da.b = this.executionContext;
                break;
            case "ActualDataProvider":
                this.actualDataProvider.pageSizeRequested = this.pageSizeRequested;
                this.actualDataProvider.pageLoaded = runOn(this, this.en);
                this.actualDataProvider.batchCompleted = runOn(this, this.em);
                this.queueAutoRefresh();
                break;
            case "PageSizeRequested":
                ...
                break;
            case "ActualPageSize":
                this.da.ag = this.actualPageSize;
                this.queueAutoRefresh();
                break;
            case "FirstVisibleIndexRequested":
                this.da.aa = this.firstVisibleIndexRequested;
                break;
            case "LastVisibleIndexRequested":
                this.da.ae = this.lastVisibleIndexRequested;
                break;
            case "ActualCount":
                if (this.actualDataProvider != null && !this.dc.q) {
                    this.da.ab = this.actualDataProvider.actualCount;
                }
                else {
                    this.da.ab = this.actualCount;
                }
                this.queueAutoRefresh();
                break;
            case "MaxCachedPages":
                this.dd.h = this.maxCachedPages;
                break;
        }
    };
    VirtualDataSource.prototype.d6 = function (a) {
        if (this.ao && this.dc.q) {
            var b = this.db(a);
            if (b == null) {
                b = this.dc.d();
            }
    ...
    VirtualDataSource.prototype.en = function (a, b, c) {
        var _this = this;
        var d = this.executionContext;
        if (d != null) {
            d.execute(function () { return _this.et(a, b, c); });
        }
        else {
            this.et(a, b, c);
        }
    };
    VirtualDataSource.prototype.et = function (a, b, c) {
        if (a == null) {
        ...
        if (this.summaryDescriptions.k.count > 0 && this.cy == null && f != null) {
            this.cy = f;
            for (var g = 0; g < this.summaryDescriptions.k.count; g++) {
                this.cy[g].summaryIndex = g;
            }
            var h = SectionData.r(this.cy);
            this.d3 = h.count;
        }
        var i = a.getGroupInformation();
        if (this.groupDescriptions.k.count > 0 && this.ct == null && i != null) {
            this.ct = i;
            this.es();
            this.dg = false;
        }
    ...
    VirtualDataSource.prototype.resolveFullCount = function (a) {
        if (this.ct != null) {
            return this.dc.u + this.d3;
        }
        return a + this.d3;
    };
    VirtualDataSource.prototype.es = function () {
        var a = 0;
        var b = 0;
        var c = this.shouldEmitSectionHeaders;
        var d = this.shouldEmitSectionFooters;
        for (var e = 0; e < this.ct.length; e++) {
            var f = new SectionData();
            var g = b;
            var h = this.ct[e].endIndex - this.ct[e].startIndex;
            f.af = a;
            f.ae = e;
            ...
            f.ad = a + h;
            f.t = 0;
            f.e = this.ct[e].groupKeyProperties;
            f.f = this.ct[e].groupKeyValues;
            f.h = new Array(0);
            ...
            if (this.summaryScope == 0 || this.summaryScope == 2) {
                if (this.ct[e].summaryResults != null) {
                    f.i[this.groupDescriptions.k.count - 1] = this.ct[e].summaryResults;
                    if (f.i != null) {
            ...
            for (var o = l; o < f.c.length; o++) {
                ...
                f.a[o] = p;
                f.b[o] = o - l;
                if (this.dj.containsKey(p)) {
                    f.c[o] = this.dj.item(p);
                }
                else {
        ...
        var t = 0;
        for (var u = 0; u < this.dc.t.count; u++) {
            var v = this.dc.t._inner[u];
    ...
    VirtualDataSource.prototype.el = function (a, b) {
        if (b) {
            this.cv = new Array(this.groupDescriptions.k.count);
            for (var c = 0; c < this.cv.length; c++) {
                this.cv[c] = a;
            }
        }
        if (this.sectionHeaderDisplayMode == 1) {
            ...
            for (var f = 0; f < e; f++) {
                ...
                var g = false;
                if (this.cv[f].f[f] == null) {
                    g = a.f[f] != null;
                }
                else {
                    g = !Base.equalsStatic(this.cv[f].f[f], a.f[f]);
                }
                if (g) {
                    this.cv[f] = a;
                    if (f - 1 > -1) {
                        var h = f - 1;
                        while (h >= 0 && this.cv[h].o) {
                            h = h - 1;
                        }
                        a.z = this.cv[h].ae;
                    }
            ...
            for (var j = 0; j < a.e.length; j++) {
                if (this.cv[0].f[j] == null) {
                    if (this.cv[0].f[j] != a.f[j]) {
                        i = true;
                        break;
                    }
                    continue;
                }
                if (!Base.equalsStatic(this.cv[0].f[j], a.f[j])) {
                    i = true;
                    break;
                }
            }
    ...
    VirtualDataSource.prototype.d5 = function (a) {
        if (this.ao && this.dc.q) {
            var b = this.dc.g(a);
            if (b == null) {
                b = this.dc.d();
    ...
    VirtualDataSource.prototype.ea = function (a) {
        if (a >= this.actualCount - this.d3) {
            ...
            b.rowType = 4;
            b.level = 0;
            var c = a - (this.actualCount - this.d3);
            var d = SectionData.r(this.cy);
    ...
    VirtualDataSource.prototype.db = function (a) {
        return this.dc.e(a);
    };
    VirtualDataSource.prototype.getItemPropertyAtIndex = function (a, b) {
        if (a > (this.actualCount - 1) - this.d3) {
            return this.eb(a, b);
        }
        var c = this.cz(a);
        var d = c[0];
    ...
    VirtualDataSource.prototype.eq = function (a) {
        if (!this.dl.containsKey(a)) {
            this.dl.addItem(a, 1);
        }
        else {
            this.dl.item(a, this.dl.item(a) + 1);
        }
    };
    ...
    VirtualDataSource.prototype.removeCandidate = function (a) {
        if (this.dk.containsKey(a)) {
            for (var b = 0; b < this.dk.item(a).length; b++) {
                var c = this.dk.item(a)[b];
                this.eo(c);
            }
    ...
    VirtualDataSource.prototype.transformPage = function (a) {
        ...
        if (this.ao && this.dc.q) {
            ...
            for (var g = c; g <= d; g++) {
                ...
                if (g > e.ad) {
                    if (e.ae < this.dc.t.count - 1) {
                        e = this.dc.t._inner[e.ae + 1];
                    }
                    else {
                        break;
                    }
    ...
    VirtualDataSource.prototype.getUnrealizedCount = function () {
        var a = this.dd.g * this.actualPageSize;
    ...
    VirtualDataSource.prototype.eu = function () {
        var e_1, _a;
        if (this.actualDataProvider != null) {
            try {
                for (var _b = tslib_1.__values(fromEnum(this.dk.values)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var a = _c.value;
    ...
    VirtualDataSource.prototype.indexOfItem = function (a) {
        ...
        for (var g = 0; g < e; g++) {
            ...
            var i = h.count();
            for (var j = 0; j < i; j++) {
                if (this.di(h.getItemAtIndex(j), a)) {
    ...
    VirtualDataSource.prototype.di = function (a, b) {
        if (a == null && b == null) {
            return true;
        }
        if (a == null || b == null) {
    ...
    VirtualDataSource.prototype.indexOfKey = function (a) {
        ...
        var c = this.c9();
        if (this.ao && this.shouldEmitSectionHeaders && !this.isSectionContentVisible && this.isSectionHeaderNormalRow) {
            if (this.dc.t.count > 0) {
                for (var d = 0; d < this.dc.t.count; d++) {
                    var e = this.dc.t._inner[d];
    ...
    VirtualDataSource.prototype.c9 = function () {
        var a = new Array(this.actualPrimaryKey.length);
        for (var b = 0; b < a.length; b++) {
            a[b] = 0;
        }
        return new DataSourcePropertiesComparer(this.actualPrimaryKey, a, this.cx, this);
    };
    ...
    VirtualDataSource.prototype.getStickyRowsInRange = function (a, b) {
        ...
        var d = this.db(b);
        if (this.dc.t.count > 0) {
            if (this.dc.t.count == 1) {
                c = this.dc.t._inner[0];
                d = this.dc.t._inner[0];
            }
            else {
                c = this.dc.e(a);
                if (c != null) {
                    while (c.z != -1) {
                        c = this.dc.t._inner[c.z];
                    }
                }
                d = this.dc.e(b);
                if (b >= this.actualCount - this.d3) {
                    d = this.dc.d();
                }
            }
        }
            ...
            for (var f = this.actualCount - this.d3; f < this.actualCount; f++) {
                e.add(f);
            }
            return e.toArray();
        }
        ...
        if (c.ae == this.dv && c.aa == this.dx && c.af == this.dy && c.ad == this.dw && c.ah == this.d0 && c.ag == this.dz && d.ae == this.dn && d.aa == this.dq && d.af == this.dr && d.ad == this.dp && d.ah == this.dt && d.ag == this.ds && this.d3 == this.du) {
            return this.cu;
        }
        this.dv = c.ae;
        this.dn = d.ae;
        ...
        for (var h = c.ae; h <= d.ae; h++) {
            var i = this.dc.t._inner[h];
            var j = i.c.length;
            var k = i.v();
            if (this.shouldEmitSectionHeaders && this.ao) {
            ...
            if (this.shouldEmitSectionFooters && this.ao) {
        ...
        for (var r = this.actualCount - this.d3; r < this.actualCount; r++) {
            g.add(r);
        }
        this.cu = g.toArray();
        return this.cu;
        ...
        for (var d = 0; d < c.a.length; d++) {
            if (c.a[d] != null) {
                if (a == c.af + c.b[d]) {
                    var e = false;
                    var f = c.a[d];
                    if (this.dj.containsKey(f) && this.dj.item(f) != b) {
                        var g = this.dj.item(f);
                        if (b == this.isSectionExpandedDefault) {
                            this.dj.removeItem(f);
                        }
                        else {
                            this.dj.item(f, b);
                        }
                    ...
                    if (e) {
                        ...
                        this.es();
                        this.dg = true;
                        if (this.actualCount != this.dc.u) {
                            this.actualCount = this.dc.u + this.d3;
                        }
                        else {
                            this.queueAutoRefresh();
                        }
    ...
    VirtualDataSource.prototype.ee = function (a) {
        var b = "";
    ...
    VirtualDataSource.prototype.ef = function (a, b) {
        if (this.sectionHeaderDisplayMode == 0) {
            return this.ee(a);
        }
        var c = "";
    ...
    VirtualDataSource.prototype.getSectionSummaryResults = function (a) {
        if (this.dc.t.count > 0 && a >= 0 && a < this.dc.t.count) {
            return this.dc.t._inner[a].i;
        }
        return null;
    };
    ...
    VirtualDataSource.prototype.updatePropertyAtKey = function (a, b, c, d) {
        ...
        if (this.concurrencyTag != null && this.ap()) {
    ...
    VirtualDataSource.prototype.cm = function (a, b) {
        if (a == 5) {
            var c = b;
            var d_1 = c.a;
    ...
    VirtualDataSource.prototype.em = function (a, b, c) {
        if (b) {
            this.queueAutoRefresh();
        }
