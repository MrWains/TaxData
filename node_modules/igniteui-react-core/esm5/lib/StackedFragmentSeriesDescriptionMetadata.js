 ...
 * @hidden
 */
var StackedFragmentSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(StackedFragmentSeriesDescriptionMetadata, _super);
    function StackedFragmentSeriesDescriptionMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    StackedFragmentSeriesDescriptionMetadata.b = function (a) {
    ...
    StackedFragmentSeriesDescriptionMetadata.c = function (a, b) {
        ...
        b.item("LegendItemVisibility@names", "Visible;Collapsed");
        b.item("ActualLegendItemVisibility", "ExportedType:string:Visibility");
        b.item("ActualLegendItemVisibility@names", "Visible;Collapsed");
        ...
        b.item("ActualMarkerType@names", "Unset;None;Automatic;Circle;Triangle;Pyramid;Square;Diamond;Pentagon;Hexagon;Tetragram;Pentagram;Hexagram;Hidden");
        b.item("Name", "String");
        ...
        b.item("ActualMarkerFillOpacity", "Number:double");
        b.item("OutlineMode", "ExportedType:string:SeriesOutlineMode");
        b.item("OutlineMode@names", "Auto;Visible;Collapsed");
        b.item("ActualOutlineMode", "ExportedType:string:SeriesOutlineMode");
        b.item("ActualOutlineMode@names", "Auto;Visible;Collapsed");
        b.item("HighlightingFadeOpacity", "Number:double");
        b.item("ActualHighlightingFadeOpacity", "Number:double");
        ...
        b.item("ActualMarkerThickness", "Number:double");
        b.item("TitleRef", "(w:Title,wf:Title)DataRef");
        b.item("ValueMemberPath", "String");
        b.item("Visibility", "ExportedType:string:Visibility");
        b.item("Visibility@names", "Visible;Collapsed");
        b.item("ActualVisibility", "ExportedType:string:Visibility");
        b.item("ActualVisibility@names", "Visible;Collapsed");
        b.item("ParentOrLocalBrush", "Brush");
        b.item("PropertyUpdatedRef", "EventRef::propertyUpdated");
    };
    StackedFragmentSeriesDescriptionMetadata.d = function (a) {
        StackedFragmentSeriesDescriptionMetadata.b(a);
        a.q("StackedFragmentSeries", function () { return new StackedFragmentSeriesDescription(); });
        a.p("StackedFragmentSeries", StackedFragmentSeriesDescriptionMetadata.a);
    };
...
export { StackedFragmentSeriesDescriptionMetadata };
