...
var CodeGeneratingRendererResult = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(CodeGeneratingRendererResult, _super);
    function CodeGeneratingRendererResult() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.m = new List$1(CodeGenerationItemBuilderPropertyInfo.$, 0);
        _this._platform = 0;
        _this._generationOptions = null;
        _this.i = new Dictionary$2(String_$type, List$1.$.specialize(String_$type), 0);
        _this.k = new Dictionary$2(String_$type, List$1.$.specialize(CodeGeneratingImportManager.$), 0);
        ...
        _this.j = new Dictionary$2(String_$type, String_$type, 0);
        return _this;
    }
    Object.defineProperty(CodeGeneratingRendererResult.prototype, "p", {
        get: function () {
            return this.m;
        },
        enumerable: true,
    ...
    CodeGeneratingRendererResult.prototype.getKeys = function () {
        ...
        try {
            for (var _b = tslib_1.__values(fromEnum(this.i.keys)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var b = _c.value;
                a.add(b);
            }
        }
    ...
    CodeGeneratingRendererResult.prototype.n = function (a) {
        if (!this.k.containsKey(a)) {
            return null;
        }
    ...
    CodeGeneratingRendererResult.prototype.z = function (a) {
        this.m.add(a);
    };
    CodeGeneratingRendererResult.prototype.getNewFiles = function () {
        ...
        var a = new List$1(String_$type, 0);
        try {
            for (var _b = tslib_1.__values(fromEnum(this.h.keys)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var b = _c.value;
                a.add(b);
            }
        }
