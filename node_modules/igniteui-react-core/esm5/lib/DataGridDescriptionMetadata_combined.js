...
var DataGridDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataGridDescriptionMetadata.c = function (a, b) {
        ...
        b.item("ColumnResizingMode@names", "Deferred;Immediate;None");
        b.item("ColumnMovingMode", "ExportedType:string:ColumnMovingMode");
        b.item("ColumnMovingMode@names", "Deferred;None");
        b.item("IsRowHoverEnabled", "Boolean");
        b.item("RowHoverBackground", "Brush");
        b.item("RowHoverTextColor", "Brush");
        ...
        b.item("HeaderClickAction@names", "SortByOneColumnOnly;SortByMultipleColumns;SortByOneColumnOnlyTriState;SortByMultipleColumnsTriState;None");
        b.item("EditMode", "ExportedType:string:EditModeType");
        b.item("EditMode@names", "None;Cell;CellBatch;Row");
        b.item("EditModeClickAction", "ExportedType:string:EditModeClickAction");
        b.item("EditModeClickAction@names", "None;SingleClick;DoubleClick");
        b.item("EditOnKeyPress", "Boolean");
        ...
        b.item("ColumnAddingAnimationMode@names", "Auto;None;SlideFromLeft;SlideFromRight;SlideFromTop;SlideFromBottom;FadeIn;SlideFromLeftAndFadeIn;SlideFromRightAndFadeIn;SlideFromTopAndFadeIn;SlideFromBottomAndFadeIn");
        b.item("ColumnPropertyUpdatingAnimationMode", "ExportedType:string:ColumnPropertyUpdatingAnimationMode");
        b.item("ColumnPropertyUpdatingAnimationMode@names", "Auto;None;Interpolate;InterpolateDeep");
        b.item("CellDataLoadedAnimationMode", "ExportedType:string:CellDataLoadedAnimationMode");
        b.item("CellDataLoadedAnimationMode@names", "Auto;None;CrossFade");
        b.item("RowSelectionAnimationMode", "ExportedType:string:RowSelectionAnimationMode");
        b.item("RowSelectionAnimationMode@names", "Auto;None;ColorBlend");
        b.item("RowHoverAnimationMode", "ExportedType:string:RowHoverAnimationMode");
        b.item("RowHoverAnimationMode@names", "Auto;None;ColorBlend");
        b.item("CellSelectionAnimationMode", "ExportedType:string:CellSelectionAnimationMode");
        b.item("CellSelectionAnimationMode@names", "Auto;None;ColorBlend");
        ...
        b.item("ColumnResizingAnimationMode@names", "Auto;None;Interpolate");
        b.item("ColumnShowingAnimationMode", "ExportedType:string:ColumnShowingAnimationMode");
        b.item("ColumnShowingAnimationMode@names", "Auto;None;SlideFromLeft;SlideFromRight;SlideFromTop;SlideFromBottom;FadeIn;SlideFromLeftAndFadeIn;SlideFromRightAndFadeIn;SlideFromTopAndFadeIn;SlideFromBottomAndFadeIn");
        b.item("ColumnMovingAnimationMode", "ExportedType:string:ColumnMovingAnimationMode");
        b.item("ColumnMovingAnimationMode@names", "Auto;None;SlideOver");
        b.item("ColumnHidingAnimationMode", "ExportedType:string:ColumnHidingAnimationMode");
        b.item("ColumnHidingAnimationMode@names", "Auto;None;SlideToLeft;SlideToRight;SlideToTop;SlideToBottom;FadeOut;SlideToLeftAndFadeOut;SlideToRightAndFadeOut;SlideToTopAndFadeOut;SlideToBottomAndFadeOut");
        b.item("ColumnExchangingAnimationMode", "ExportedType:string:ColumnExchangingAnimationMode");
        b.item("ColumnExchangingAnimationMode@names", "Auto;None;SlideToLeft;SlideToRight;SlideToTop;SlideToBottom;Crossfade;SlideToLeftAndCrossfade;SlideToRightAndCrossfade;SlideToTopAndCrossfade;SlideToBottomAndCrossfade");
        b.item("SelectionMode", "ExportedType:string:GridSelectionMode");
        b.item("SelectionMode@names", "None;SingleRow;MultipleRow;SingleCell;MultipleCell;RangeCell");
        b.item("ActivationMode", "ExportedType:string:GridActivationMode");
        b.item("ActivationMode@names", "None;Cell");
        b.item("SelectionBehavior", "ExportedType:string:GridSelectionBehavior");
        b.item("SelectionBehavior@names", "Toggle;ModifierBased");
        ...
        b.item("HeaderSortIndicatorStyle@names", "Default;FadingUpDownArrows;FadingSimpleUpDownArrows;Unset");
        ...
        b.item("ColumnOptionsIconAlignment@names", "Unset;None;Opposite");
        b.item("ColumnOptionsIconColor", "Brush");
        b.item("ColumnOptionsIconBehavior", "ExportedType:string:ColumnOptionsIconBehavior");
        b.item("ColumnOptionsIconBehavior@names", "Unset;AlwaysVisible;AppearOnHover;AppearOnHoverAnimate");
        b.item("Border", "Brush");
        ...
        b.item("EnterBehavior", "ExportedType:string:EnterKeyBehaviors");
        b.item("EnterBehavior@names", "None;Edit;MoveDown;MoveRight;MoveUp;MoveLeft");
        b.item("EnterBehaviorAfterEdit", "ExportedType:string:EnterKeyBehaviorAfterEdit");
        b.item("EnterBehaviorAfterEdit@names", "None;MoveDown;MoveRight;MoveUp;MoveLeft");
        b.item("IsColumnOptionsSummariesEnabled", "Boolean");
    ...
    DataGridDescriptionMetadata.d = function (a) {
        ...
        a.q("DataGrid", function () { return new DataGridDescription(); });
        a.p("DataGrid", DataGridDescriptionMetadata.a);
    };
...
var GridCellEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridCellEventArgsDescriptionMetadata.c = function (a, b) {
        b.item("CellInfo", "ExportedType:CellModel");
        b.item("Grid", "ExportedType:Grid");
        b.item("Button", "ExportedType:string:MouseButton");
        b.item("Button@names", "Left;Middle;Right;Unkown");
        b.item("IsDoubleClick", "Boolean");
    };
    GridCellEventArgsDescriptionMetadata.d = function (a) {
        GridCellEventArgsDescriptionMetadata.b(a);
        a.q("GridCellEventArgs", function () { return new GridCellEventArgsDescription(); });
        a.p("GridCellEventArgs", GridCellEventArgsDescriptionMetadata.a);
    };
