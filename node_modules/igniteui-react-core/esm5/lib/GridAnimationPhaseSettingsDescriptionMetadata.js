...
var GridAnimationPhaseSettingsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridAnimationPhaseSettingsDescriptionMetadata.c = function (a, b) {
        ...
        b.item("EasingFunctionType@names", "Linear;CubicInOut;ExponentialInOut;CircleInOut");
    };
    GridAnimationPhaseSettingsDescriptionMetadata.d = function (a) {
        GridAnimationPhaseSettingsDescriptionMetadata.b(a);
        a.q("GridAnimationPhaseSettings", function () { return new GridAnimationPhaseSettingsDescription(); });
        a.p("GridAnimationPhaseSettings", GridAnimationPhaseSettingsDescriptionMetadata.a);
    };
