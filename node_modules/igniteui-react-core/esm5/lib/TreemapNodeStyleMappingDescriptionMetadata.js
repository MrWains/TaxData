...
var TreemapNodeStyleMappingDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TreemapNodeStyleMappingDescriptionMetadata.c = function (a, b) {
        ...
        b.item("TargetType@names", "All;Parent;Child");
        ...
        b.item("MappingMode@names", "Sum;Value;CustomValue");
    };
    TreemapNodeStyleMappingDescriptionMetadata.d = function (a) {
        TreemapNodeStyleMappingDescriptionMetadata.b(a);
        a.q("TreemapNodeStyleMapping", function () { return new TreemapNodeStyleMappingDescription(); });
        a.p("TreemapNodeStyleMapping", TreemapNodeStyleMappingDescriptionMetadata.a);
    };
