 ...
 * @hidden
 */
var FinalValueLayerDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FinalValueLayerDescriptionMetadata.c = function (a, b) {
        ...
        b.item("FinalValueSelectionMode@names", "Auto;FinalVisible;FinalVisibleInterpolated;Final");
    ...
    FinalValueLayerDescriptionMetadata.d = function (a) {
        ...
        a.q("FinalValueLayer", function () { return new FinalValueLayerDescription(); });
        a.p("FinalValueLayer", FinalValueLayerDescriptionMetadata.a);
    };
