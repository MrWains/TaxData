 ...
 * @hidden
 */
export let ScaleLegendDescriptionMetadata = /*@__PURE__*/ (() => {
    class ScaleLegendDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("ScaleLegend", () => new ScaleLegendDescription());
            a.p("ScaleLegend", ScaleLegendDescriptionMetadata.a);
        }
    }
    ScaleLegendDescriptionMetadata.$t = /*@__PURE__*/ markType(ScaleLegendDescriptionMetadata, 'ScaleLegendDescriptionMetadata');
