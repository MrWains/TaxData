 ...
 * @hidden
 */
export let TemplateHeaderCellUpdatingEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class TemplateHeaderCellUpdatingEventArgsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("TemplateHeaderCellUpdatingEventArgs", () => new TemplateHeaderCellUpdatingEventArgsDescription());
            a.p("TemplateHeaderCellUpdatingEventArgs", TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.a);
        }
    }
    TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(TemplateHeaderCellUpdatingEventArgsDescriptionMetadata, 'TemplateHeaderCellUpdatingEventArgsDescriptionMetadata');
