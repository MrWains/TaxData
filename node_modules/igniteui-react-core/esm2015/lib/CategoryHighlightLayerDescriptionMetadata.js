 ...
 * @hidden
 */
export let CategoryHighlightLayerDescriptionMetadata = /*@__PURE__*/ (() => {
    class CategoryHighlightLayerDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("CategoryHighlightLayer", () => new CategoryHighlightLayerDescription());
            a.p("CategoryHighlightLayer", CategoryHighlightLayerDescriptionMetadata.a);
        }
    }
    CategoryHighlightLayerDescriptionMetadata.$t = /*@__PURE__*/ markType(CategoryHighlightLayerDescriptionMetadata, 'CategoryHighlightLayerDescriptionMetadata');
