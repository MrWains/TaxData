 ...
 * @hidden
 */
export let TemplateHeaderDescriptionMetadata = /*@__PURE__*/ (() => {
    class TemplateHeaderDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("TemplateHeader", () => new TemplateHeaderDescription());
            a.p("TemplateHeader", TemplateHeaderDescriptionMetadata.a);
        }
    }
    TemplateHeaderDescriptionMetadata.$t = /*@__PURE__*/ markType(TemplateHeaderDescriptionMetadata, 'TemplateHeaderDescriptionMetadata');
