 ...
 * @hidden
 */
export let BarSeriesDescriptionMetadata = /*@__PURE__*/ (() => {
    class BarSeriesDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("BarSeries", () => new BarSeriesDescription());
            a.p("BarSeries", BarSeriesDescriptionMetadata.a);
        }
    }
    BarSeriesDescriptionMetadata.$t = /*@__PURE__*/ markType(BarSeriesDescriptionMetadata, 'BarSeriesDescriptionMetadata');
