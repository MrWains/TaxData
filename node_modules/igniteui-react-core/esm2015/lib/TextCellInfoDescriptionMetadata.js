 ...
 * @hidden
 */
export let TextCellInfoDescriptionMetadata = /*@__PURE__*/ (() => {
    class TextCellInfoDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("TextCellInfo", () => new TextCellInfoDescription());
            a.p("TextCellInfo", TextCellInfoDescriptionMetadata.a);
        }
    }
    TextCellInfoDescriptionMetadata.$t = /*@__PURE__*/ markType(TextCellInfoDescriptionMetadata, 'TextCellInfoDescriptionMetadata');
