 ...
 * @hidden
 */
export let WeightedCloseIndicatorDescriptionMetadata = /*@__PURE__*/ (() => {
    class WeightedCloseIndicatorDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("WeightedCloseIndicator", () => new WeightedCloseIndicatorDescription());
            a.p("WeightedCloseIndicator", WeightedCloseIndicatorDescriptionMetadata.a);
        }
    }
    WeightedCloseIndicatorDescriptionMetadata.$t = /*@__PURE__*/ markType(WeightedCloseIndicatorDescriptionMetadata, 'WeightedCloseIndicatorDescriptionMetadata');
