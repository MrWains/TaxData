 ...
 * @hidden
 */
export let CustomPaletteColorScaleDescriptionMetadata = /*@__PURE__*/ (() => {
    class CustomPaletteColorScaleDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("InterpolationMode@names", "Select;InterpolateRGB;InterpolateHSV");
        }
        static d(a) {
            CustomPaletteColorScaleDescriptionMetadata.b(a);
            a.q("CustomPaletteColorScale", () => new CustomPaletteColorScaleDescription());
            a.p("CustomPaletteColorScale", CustomPaletteColorScaleDescriptionMetadata.a);
        }
    }
    CustomPaletteColorScaleDescriptionMetadata.$t = /*@__PURE__*/ markType(CustomPaletteColorScaleDescriptionMetadata, 'CustomPaletteColorScaleDescriptionMetadata');
