 ...
 * @hidden
 */
export let TemplateSectionHeaderCellInfoDescriptionMetadata = /*@__PURE__*/ (() => {
    class TemplateSectionHeaderCellInfoDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("TemplateSectionHeaderCellInfo", () => new TemplateSectionHeaderCellInfoDescription());
            a.p("TemplateSectionHeaderCellInfo", TemplateSectionHeaderCellInfoDescriptionMetadata.a);
        }
    }
    TemplateSectionHeaderCellInfoDescriptionMetadata.$t = /*@__PURE__*/ markType(TemplateSectionHeaderCellInfoDescriptionMetadata, 'TemplateSectionHeaderCellInfoDescriptionMetadata');
