 ...
 * @hidden
 */
export let FinancialEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class FinancialEventArgsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("DataSource", "ExportedType:FinancialCalculationDataSource");
            b.item("SupportingCalculations", "ExportedType:FinancialCalculationSupportingCalculations");
        }
        static d(a) {
            FinancialEventArgsDescriptionMetadata.b(a);
            a.q("FinancialEventArgs", () => new FinancialEventArgsDescription());
            a.p("FinancialEventArgs", FinancialEventArgsDescriptionMetadata.a);
        }
    }
    FinancialEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(FinancialEventArgsDescriptionMetadata, 'FinancialEventArgsDescriptionMetadata');
