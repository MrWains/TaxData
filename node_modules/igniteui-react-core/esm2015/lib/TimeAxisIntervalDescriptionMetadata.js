 ...
 * @hidden
 */
export let TimeAxisIntervalDescriptionMetadata = /*@__PURE__*/ (() => {
    class TimeAxisIntervalDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("IntervalType@names", "Ticks;Milliseconds;Seconds;Minutes;Hours;Days;Weeks;Months;Years");
        }
        static d(a) {
            TimeAxisIntervalDescriptionMetadata.b(a);
            a.q("TimeAxisInterval", () => new TimeAxisIntervalDescription());
            a.p("TimeAxisInterval", TimeAxisIntervalDescriptionMetadata.a);
        }
    }
    TimeAxisIntervalDescriptionMetadata.$t = /*@__PURE__*/ markType(TimeAxisIntervalDescriptionMetadata, 'TimeAxisIntervalDescriptionMetadata');
