 ...
 * @hidden
 */
export let AxisDescriptionMetadata = /*@__PURE__*/ (() => {
    class AxisDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("LabelLocation@names", "OutsideTop;OutsideBottom;OutsideLeft;OutsideRight;InsideTop;InsideBottom;InsideLeft;InsideRight");
            ...
            b.item("LabelHorizontalAlignment@names", "Left;Center;Right;Stretch");
            ...
            b.item("LabelVerticalAlignment@names", "Top;Center;Bottom;Stretch");
            b.item("CrossingAxisRef", "(w:CrossingAxis,wf:CrossingAxis)DataRef::object");
            b.item("CrossingAxisRef@nameBinding", "true");
            b.item("CrossingValue", "Unknown");
            b.item("TitlePosition", "(w:TitleSettings.Position,wf:TitlePosition)ExportedType:string:AxisTitlePosition");
            b.item("TitlePosition@names", "Auto;Left;Right;Top;Bottom");
            ...
            b.item("TitleLocation@names", "OutsideTop;OutsideBottom;OutsideLeft;OutsideRight;InsideTop;InsideBottom;InsideLeft;InsideRight");
            ...
            b.item("TitleVerticalAlignment@names", "Top;Center;Bottom;Stretch");
            b.item("Annotations", "Collection:AxisAnnotation:AxisAnnotationCollection:IAxisAnnotation");
        ...
        static d(a) {
            ...
            a.p("Axis", AxisDescriptionMetadata.a);
        }
        static e(a, b) {
            b.item("Label", "(w:Label/AxisLabelTransform)String");
            b.item("LabelTextColor", "(w:LabelSettings.Foreground,wf:LabelTextColor,web:LabelTextColor)Brush");
            b.item("TitleTextColor", "(w:TitleSettings.Foreground,wf:TitleTextColor,web:TitleTextColor)Brush");
            ...
            b.item("LabelSettings", "ExportedType:AxisLabelSettings");
        }
    }
    AxisDescriptionMetadata.$t = /*@__PURE__*/ markType(AxisDescriptionMetadata, 'AxisDescriptionMetadata');
