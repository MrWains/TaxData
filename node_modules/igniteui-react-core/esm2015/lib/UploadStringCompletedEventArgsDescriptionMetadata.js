 ...
 * @hidden
 */
export let UploadStringCompletedEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class UploadStringCompletedEventArgsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("UploadStringCompletedEventArgs", () => new UploadStringCompletedEventArgsDescription());
            a.p("UploadStringCompletedEventArgs", UploadStringCompletedEventArgsDescriptionMetadata.a);
        }
    }
    UploadStringCompletedEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(UploadStringCompletedEventArgsDescriptionMetadata, 'UploadStringCompletedEventArgsDescriptionMetadata');
