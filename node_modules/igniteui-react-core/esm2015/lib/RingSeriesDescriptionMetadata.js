 ...
 * @hidden
 */
export let RingSeriesDescriptionMetadata = /*@__PURE__*/ (() => {
    class RingSeriesDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("Ring", "ExportedType:Ring");
        }
        static d(a) {
            RingSeriesDescriptionMetadata.b(a);
            a.q("RingSeries", () => new RingSeriesDescription());
            a.p("RingSeries", RingSeriesDescriptionMetadata.a);
        }
    }
    RingSeriesDescriptionMetadata.$t = /*@__PURE__*/ markType(RingSeriesDescriptionMetadata, 'RingSeriesDescriptionMetadata');
