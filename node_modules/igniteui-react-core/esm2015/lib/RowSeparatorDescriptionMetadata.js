 ...
 * @hidden
 */
export let RowSeparatorDescriptionMetadata = /*@__PURE__*/ (() => {
    class RowSeparatorDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("RowSeparator", () => new RowSeparatorDescription());
            a.p("RowSeparator", RowSeparatorDescriptionMetadata.a);
        }
    }
    RowSeparatorDescriptionMetadata.$t = /*@__PURE__*/ markType(RowSeparatorDescriptionMetadata, 'RowSeparatorDescriptionMetadata');
