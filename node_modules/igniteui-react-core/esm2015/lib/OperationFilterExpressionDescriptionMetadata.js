 ...
 * @hidden
 */
export let OperationFilterExpressionDescriptionMetadata = /*@__PURE__*/ (() => {
    class OperationFilterExpressionDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("Operator@names", "None;Equal;NotEqual;GreaterThan;GreaterThanOrEqual;LessThan;LessThanOrEqual;And;Or;Not;Add;Subtract;Multiply;Divide;Modulo;Grouping");
        }
        static d(a) {
            OperationFilterExpressionDescriptionMetadata.b(a);
            a.q("OperationFilterExpression", () => new OperationFilterExpressionDescription());
            a.p("OperationFilterExpression", OperationFilterExpressionDescriptionMetadata.a);
        }
    }
    OperationFilterExpressionDescriptionMetadata.$t = /*@__PURE__*/ markType(OperationFilterExpressionDescriptionMetadata, 'OperationFilterExpressionDescriptionMetadata');
