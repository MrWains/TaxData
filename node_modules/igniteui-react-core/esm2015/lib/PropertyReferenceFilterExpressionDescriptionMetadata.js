 ...
 * @hidden
 */
export let PropertyReferenceFilterExpressionDescriptionMetadata = /*@__PURE__*/ (() => {
    class PropertyReferenceFilterExpressionDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("PropertyReferenceFilterExpression", () => new PropertyReferenceFilterExpressionDescription());
            a.p("PropertyReferenceFilterExpression", PropertyReferenceFilterExpressionDescriptionMetadata.a);
        }
    }
    PropertyReferenceFilterExpressionDescriptionMetadata.$t = /*@__PURE__*/ markType(PropertyReferenceFilterExpressionDescriptionMetadata, 'PropertyReferenceFilterExpressionDescriptionMetadata');
