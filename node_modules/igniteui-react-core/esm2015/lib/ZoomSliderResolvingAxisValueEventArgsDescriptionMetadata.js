 ...
 * @hidden
 */
export let ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("ZoomSliderResolvingAxisValueEventArgs", () => new ZoomSliderResolvingAxisValueEventArgsDescription());
            a.p("ZoomSliderResolvingAxisValueEventArgs", ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata.a);
        }
    }
    ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata, 'ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata');
