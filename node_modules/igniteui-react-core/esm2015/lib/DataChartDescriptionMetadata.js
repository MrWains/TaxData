 ...
 * @hidden
 */
export let DataChartDescriptionMetadata = /*@__PURE__*/ (() => {
    class DataChartDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("GridMode@names", "None;BeforeSeries;BehindSeries");
            ...
            b.item("ActualPlotAreaMarginLeft", "Number:double");
            b.item("ActualPlotAreaMarginTop", "Number:double");
            b.item("ActualPlotAreaMarginRight", "Number:double");
            b.item("ActualPlotAreaMarginBottom", "Number:double");
        ...
        static d(a) {
            ...
            a.q("DataChart", () => new DataChartDescription());
            a.p("DataChart", DataChartDescriptionMetadata.a);
        }
        static e(a, b) {
    ...
    DataChartDescriptionMetadata.$t = /*@__PURE__*/ markType(DataChartDescriptionMetadata, 'DataChartDescriptionMetadata');
