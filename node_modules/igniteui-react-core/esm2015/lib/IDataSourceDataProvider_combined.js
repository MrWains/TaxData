...
export let SumSummaryCalculator = /*@__PURE__*/ (() => {
    class SumSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a9("DataSource_Summary_Sum");
            return a != null ? a : "Sum";
        }
        get displayName() {
...
export let CountSummaryCalculator = /*@__PURE__*/ (() => {
    class CountSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a9("DataSource_Summary_Count");
...
export let AverageSummaryCalculator = /*@__PURE__*/ (() => {
    class AverageSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a9("DataSource_Summary_Avg");
            return a != null ? a : "Avg";
        }
        get displayName() {
            return this.get_displayName();
...
export let MaxSummaryCalculator = /*@__PURE__*/ (() => {
    class MaxSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a9("DataSource_Summary_Max");
            return a != null ? a : "Max";
        }
        get displayName() {
            return this.get_displayName();
...
export let MinSummaryCalculator = /*@__PURE__*/ (() => {
    class MinSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a9("DataSource_Summary_Min");
            return a != null ? a : "Min";
        }
        get displayName() {
            return this.get_displayName();
...
export let BaseDataSource = /*@__PURE__*/ (() => {
    class BaseDataSource extends Base {
        constructor() {
            ...
            this.w = false;
            this.d = null;
            this.l = new DefaultDataSourceDataProviderUpdateNotifier(this);
            this.s = new SortDescriptionCollection();
            this.r = new SortDescriptionCollection();
            this.t = new SummaryDescriptionCollection();
            this.s.n(runOn(this, this.cr));
            this.r.n(runOn(this, this.bv));
            this.t.n(runOn(this, this.cs));
            this.i = new FilterExpressionCollection();
            this.i.m(runOn(this, this.bt));
            this.u = new TransactionService(runOn(this, this.bx), runOn(this, this.clone1), new TransactionKeyEqualityComparer());
            let a = this.u;
            a.stateChanged = delegateCombine(a.stateChanged, runOn(this, this.cn));
        }
        cn(a, b) {
            if (a == 0 || a == 1) {
        ...
        commitEdits(a) {
            if (this.ap()) {
                let b = this.u.c(null).length > 0;
                let c = this.u.s(a, this.isBatchingEnabled);
                if (c == -1 && b) {
                    if (this.updateNotifier != null) {
