...
export let ColorUtil = /*@__PURE__*/ (() => {
    class ColorUtil extends Base {
        ...
        static u(a, interpolation_, maximum_, b) {
            let min_ = a;
            switch (b) {
                case 1:
                    {
        ...
        static i(a, b) {
            if (ColorUtil.d == null) {
                ...
                for (let c of fromEnum(ColorUtil.c.keys)) {
                    let d = ColorUtil.c.item(c);
    ...
    ColorUtil.h = /*@__PURE__*/ new Random(0);
    ColorUtil.d = null;
    ColorUtil.c = /*@__PURE__*/ ((() => {
