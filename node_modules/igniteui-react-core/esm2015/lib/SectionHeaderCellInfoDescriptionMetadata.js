 ...
 * @hidden
 */
export let SectionHeaderCellInfoDescriptionMetadata = /*@__PURE__*/ (() => {
    class SectionHeaderCellInfoDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("ResolvedSummaryText", "String");
            b.item("SummaryDisplayMode", "ExportedType:string:GroupSummaryDisplayMode");
            b.item("SummaryDisplayMode@names", "List;Cells;RowTop;RowBottom;None");
        }
        static d(a) {
            SectionHeaderCellInfoDescriptionMetadata.b(a);
            a.q("SectionHeaderCellInfo", () => new SectionHeaderCellInfoDescription());
            a.p("SectionHeaderCellInfo", SectionHeaderCellInfoDescriptionMetadata.a);
        }
    }
    SectionHeaderCellInfoDescriptionMetadata.$t = /*@__PURE__*/ markType(SectionHeaderCellInfoDescriptionMetadata, 'SectionHeaderCellInfoDescriptionMetadata');
