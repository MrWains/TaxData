 ...
 * @hidden
 */
export let ChaikinVolatilityIndicatorDescriptionMetadata = /*@__PURE__*/ (() => {
    class ChaikinVolatilityIndicatorDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("ChaikinVolatilityIndicator", () => new ChaikinVolatilityIndicatorDescription());
            a.p("ChaikinVolatilityIndicator", ChaikinVolatilityIndicatorDescriptionMetadata.a);
        }
    }
    ChaikinVolatilityIndicatorDescriptionMetadata.$t = /*@__PURE__*/ markType(ChaikinVolatilityIndicatorDescriptionMetadata, 'ChaikinVolatilityIndicatorDescriptionMetadata');
