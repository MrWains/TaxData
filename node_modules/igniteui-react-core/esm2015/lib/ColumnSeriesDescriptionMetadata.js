 ...
 * @hidden
 */
export let ColumnSeriesDescriptionMetadata = /*@__PURE__*/ (() => {
    class ColumnSeriesDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("ConsolidatedColumnVerticalPosition@names", "Minimum;Maximum;Median;RelativeMinimum;RelativeMaximum");
        }
        static d(a) {
            ColumnSeriesDescriptionMetadata.b(a);
            a.q("ColumnSeries", () => new ColumnSeriesDescription());
            a.p("ColumnSeries", ColumnSeriesDescriptionMetadata.a);
        }
    }
    ColumnSeriesDescriptionMetadata.$t = /*@__PURE__*/ markType(ColumnSeriesDescriptionMetadata, 'ColumnSeriesDescriptionMetadata');
