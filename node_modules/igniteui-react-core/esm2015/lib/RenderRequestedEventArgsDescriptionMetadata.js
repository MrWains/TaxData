 ...
 * @hidden
 */
export let RenderRequestedEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class RenderRequestedEventArgsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("RenderRequestedEventArgs", () => new RenderRequestedEventArgsDescription());
            a.p("RenderRequestedEventArgs", RenderRequestedEventArgsDescriptionMetadata.a);
        }
    }
    RenderRequestedEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(RenderRequestedEventArgsDescriptionMetadata, 'RenderRequestedEventArgsDescriptionMetadata');
