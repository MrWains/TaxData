...
export let SeriesDescriptionMetadata = /*@__PURE__*/ (() => {
    class SeriesDescriptionMetadata extends Base {
        ...
        static c(a, b) {
            ...
            b.item("VisibleRangeMarginTop", "Number:double");
            b.item("VisibleRangeMarginBottom", "Number:double");
            b.item("VisibleRangeMarginLeft", "Number:double");
            b.item("VisibleRangeMarginRight", "Number:double");
            b.item("Brush", "Brush");
            ...
            b.item("ActualHighlightingMode", "ExportedType:string:SeriesHighlightingMode");
            b.item("ActualHighlightingMode@names", "Auto;None;BrightenSpecific;Brighten;FadeOthersSpecific;FadeOthers");
            b.item("ActualHighlightingFadeOpacity", "Number:double");
            b.item("HighlightingFadeOpacity", "Number:double");
            b.item("IsComponentHighlightingModeIgnored", "Boolean");
            ...
            b.item("VisibleRangeMode", "ExportedType:string:SeriesVisibleRangeMode");
            b.item("VisibleRangeMode@names", "Auto;ValuesOnly;IncludeReferenceValue");
            ...
            b.item("TransitionInSpeedType@names", "Auto;Normal;ValueScaled;IndexScaled;Random");
            ...
            b.item("HitTestMode@names", "Auto;Computational;ColorEncoded");
            b.item("ActualHitTestMode", "ExportedType:string:SeriesHitTestMode");
            b.item("ActualHitTestMode@names", "Auto;Computational;ColorEncoded");
        ...
        static d(a) {
            ...
            a.p("Series", SeriesDescriptionMetadata.a);
        }
        static e(a, b) {
