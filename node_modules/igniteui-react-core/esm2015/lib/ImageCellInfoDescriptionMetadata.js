 ...
 * @hidden
 */
export let ImageCellInfoDescriptionMetadata = /*@__PURE__*/ (() => {
    class ImageCellInfoDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("ImageStretchOption@names", "Uniform;Fill;None");
            b.item("ImageResourceType", "ExportedType:string:ImageResourceType");
            b.item("ImageResourceType@names", "Unspecified;LocalResource;LocalAsset;EmbeddedResource;RemoteResource");
        }
        static d(a) {
            ImageCellInfoDescriptionMetadata.b(a);
            a.q("ImageCellInfo", () => new ImageCellInfoDescription());
            a.p("ImageCellInfo", ImageCellInfoDescriptionMetadata.a);
        }
    }
    ImageCellInfoDescriptionMetadata.$t = /*@__PURE__*/ markType(ImageCellInfoDescriptionMetadata, 'ImageCellInfoDescriptionMetadata');
