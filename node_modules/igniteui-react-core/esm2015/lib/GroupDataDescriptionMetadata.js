 ...
 * @hidden
 */
export let GroupDataDescriptionMetadata = /*@__PURE__*/ (() => {
    class GroupDataDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("GroupData", () => new GroupDataDescription());
            a.p("GroupData", GroupDataDescriptionMetadata.a);
        }
    }
    GroupDataDescriptionMetadata.$t = /*@__PURE__*/ markType(GroupDataDescriptionMetadata, 'GroupDataDescriptionMetadata');
