 ...
 * @hidden
 */
export let CustomContourValueResolverEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class CustomContourValueResolverEventArgsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("CustomContourValueResolverEventArgs", () => new CustomContourValueResolverEventArgsDescription());
            a.p("CustomContourValueResolverEventArgs", CustomContourValueResolverEventArgsDescriptionMetadata.a);
        }
    }
    CustomContourValueResolverEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(CustomContourValueResolverEventArgsDescriptionMetadata, 'CustomContourValueResolverEventArgsDescriptionMetadata');
