 ...
 * @hidden
 */
export let PieSliceOthersContextDescriptionMetadata = /*@__PURE__*/ (() => {
    class PieSliceOthersContextDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("PieSliceOthersContext", () => new PieSliceOthersContextDescription());
            a.p("PieSliceOthersContext", PieSliceOthersContextDescriptionMetadata.a);
        }
    }
    PieSliceOthersContextDescriptionMetadata.$t = /*@__PURE__*/ markType(PieSliceOthersContextDescriptionMetadata, 'PieSliceOthersContextDescriptionMetadata');
