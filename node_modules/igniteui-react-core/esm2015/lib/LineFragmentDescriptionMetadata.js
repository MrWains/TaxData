 ...
 * @hidden
 */
export let LineFragmentDescriptionMetadata = /*@__PURE__*/ (() => {
    class LineFragmentDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("LineFragment", () => new LineFragmentDescription());
            a.p("LineFragment", LineFragmentDescriptionMetadata.a);
        }
    }
    LineFragmentDescriptionMetadata.$t = /*@__PURE__*/ markType(LineFragmentDescriptionMetadata, 'LineFragmentDescriptionMetadata');
