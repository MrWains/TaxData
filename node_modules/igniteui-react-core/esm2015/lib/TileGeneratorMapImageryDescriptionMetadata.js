 ...
 * @hidden
 */
export let TileGeneratorMapImageryDescriptionMetadata = /*@__PURE__*/ (() => {
    class TileGeneratorMapImageryDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("TileGeneratorMapImagery", () => new TileGeneratorMapImageryDescription());
            a.p("TileGeneratorMapImagery", TileGeneratorMapImageryDescriptionMetadata.a);
        }
    }
    TileGeneratorMapImageryDescriptionMetadata.$t = /*@__PURE__*/ markType(TileGeneratorMapImageryDescriptionMetadata, 'TileGeneratorMapImageryDescriptionMetadata');
