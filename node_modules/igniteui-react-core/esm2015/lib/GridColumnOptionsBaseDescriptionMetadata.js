 ...
 * @hidden
 */
export let GridColumnOptionsBaseDescriptionMetadata = /*@__PURE__*/ (() => {
    class GridColumnOptionsBaseDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            ...
            b.item("ActualBaseTheme@names", "Default;DenaliLight;MaterialLight");
            b.item("ButtonDensity", "ExportedType:string:ControlDisplayDensity");
            b.item("ButtonDensity@names", "Auto;Comfortable;Cosy;Compact");
            b.item("ActualButtonDensity", "ExportedType:string:ControlDisplayDensity");
            b.item("ActualButtonDensity@names", "Auto;Comfortable;Cosy;Compact");
            ...
            b.item("ActualDensity@names", "Auto;Comfortable;Cosy;Compact");
        ...
        static d(a) {
            ...
            a.p("GridColumnOptionsBase", GridColumnOptionsBaseDescriptionMetadata.a);
        }
    }
    GridColumnOptionsBaseDescriptionMetadata.$t = /*@__PURE__*/ markType(GridColumnOptionsBaseDescriptionMetadata, 'GridColumnOptionsBaseDescriptionMetadata');
