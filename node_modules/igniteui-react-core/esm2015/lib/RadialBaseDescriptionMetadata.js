...
export let RadialBaseDescriptionMetadata = /*@__PURE__*/ (() => {
    class RadialBaseDescriptionMetadata extends Base {
        ...
        static c(a, b) {
            ...
            b.item("IsCustomRadialStyleAllowed", "Boolean");
            b.item("IsCustomRadialMarkerStyleAllowed", "Boolean");
            ...
            b.item("ValueAxisRef@nameBinding", "true");
            b.item("ClipSeriesToBounds", "Boolean");
            b.item("AssigningRadialStyleRef", "EventRef::assigningRadialStyle");
            b.item("AssigningRadialMarkerStyleRef", "EventRef::assigningRadialMarkerStyle");
        }
        static d(a) {
            RadialBaseDescriptionMetadata.b(a);
            a.p("RadialBase", RadialBaseDescriptionMetadata.a);
        }
    }
