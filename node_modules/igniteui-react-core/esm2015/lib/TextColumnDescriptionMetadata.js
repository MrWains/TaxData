 ...
 * @hidden
 */
export let TextColumnDescriptionMetadata = /*@__PURE__*/ (() => {
    class TextColumnDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("TextColumn", () => new TextColumnDescription());
            a.p("TextColumn", TextColumnDescriptionMetadata.a);
        }
    }
    TextColumnDescriptionMetadata.$t = /*@__PURE__*/ markType(TextColumnDescriptionMetadata, 'TextColumnDescriptionMetadata');
