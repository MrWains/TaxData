 ...
 * @hidden
 */
export let DataContextDescriptionMetadata = /*@__PURE__*/ (() => {
    class DataContextDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("DataContext", () => new DataContextDescription());
            a.p("DataContext", DataContextDescriptionMetadata.a);
        }
    }
    DataContextDescriptionMetadata.$t = /*@__PURE__*/ markType(DataContextDescriptionMetadata, 'DataContextDescriptionMetadata');
