 ...
 * @hidden
 */
export let AssigningCategoryMarkerStyleEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class AssigningCategoryMarkerStyleEventArgsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("AssigningCategoryMarkerStyleEventArgs", () => new AssigningCategoryMarkerStyleEventArgsDescription());
            a.p("AssigningCategoryMarkerStyleEventArgs", AssigningCategoryMarkerStyleEventArgsDescriptionMetadata.a);
        }
    }
    AssigningCategoryMarkerStyleEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(AssigningCategoryMarkerStyleEventArgsDescriptionMetadata, 'AssigningCategoryMarkerStyleEventArgsDescriptionMetadata');
