 ...
 * @hidden
 */
export let SplineAreaFragmentDescriptionMetadata = /*@__PURE__*/ (() => {
    class SplineAreaFragmentDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("SplineAreaFragment", () => new SplineAreaFragmentDescription());
            a.p("SplineAreaFragment", SplineAreaFragmentDescriptionMetadata.a);
        }
    }
    SplineAreaFragmentDescriptionMetadata.$t = /*@__PURE__*/ markType(SplineAreaFragmentDescriptionMetadata, 'SplineAreaFragmentDescriptionMetadata');
