 ...
 * @hidden
 */
export let AverageTrueRangeIndicatorDescriptionMetadata = /*@__PURE__*/ (() => {
    class AverageTrueRangeIndicatorDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("AverageTrueRangeIndicator", () => new AverageTrueRangeIndicatorDescription());
            a.p("AverageTrueRangeIndicator", AverageTrueRangeIndicatorDescriptionMetadata.a);
        }
    }
    AverageTrueRangeIndicatorDescriptionMetadata.$t = /*@__PURE__*/ markType(AverageTrueRangeIndicatorDescriptionMetadata, 'AverageTrueRangeIndicatorDescriptionMetadata');
