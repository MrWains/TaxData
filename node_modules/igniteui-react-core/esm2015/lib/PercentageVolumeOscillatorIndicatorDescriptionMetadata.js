 ...
 * @hidden
 */
export let PercentageVolumeOscillatorIndicatorDescriptionMetadata = /*@__PURE__*/ (() => {
    class PercentageVolumeOscillatorIndicatorDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("PercentageVolumeOscillatorIndicator", () => new PercentageVolumeOscillatorIndicatorDescription());
            a.p("PercentageVolumeOscillatorIndicator", PercentageVolumeOscillatorIndicatorDescriptionMetadata.a);
        }
    }
    PercentageVolumeOscillatorIndicatorDescriptionMetadata.$t = /*@__PURE__*/ markType(PercentageVolumeOscillatorIndicatorDescriptionMetadata, 'PercentageVolumeOscillatorIndicatorDescriptionMetadata');
