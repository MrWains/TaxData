 ...
 * @hidden
 */
export let StackedColumnSeriesDescriptionMetadata = /*@__PURE__*/ (() => {
    class StackedColumnSeriesDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("StackedColumnSeries", () => new StackedColumnSeriesDescription());
            a.p("StackedColumnSeries", StackedColumnSeriesDescriptionMetadata.a);
        }
    }
    StackedColumnSeriesDescriptionMetadata.$t = /*@__PURE__*/ markType(StackedColumnSeriesDescriptionMetadata, 'StackedColumnSeriesDescriptionMetadata');
