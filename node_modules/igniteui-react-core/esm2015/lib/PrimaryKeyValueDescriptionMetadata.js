 ...
 * @hidden
 */
export let PrimaryKeyValueDescriptionMetadata = /*@__PURE__*/ (() => {
    class PrimaryKeyValueDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a, b) {
            b.item("Key", "Array:string");
            b.item("Value", "Collection:object:Array:Object");
        }
        static d(a) {
            PrimaryKeyValueDescriptionMetadata.b(a);
            a.q("PrimaryKeyValue", () => new PrimaryKeyValueDescription());
            a.p("PrimaryKeyValue", PrimaryKeyValueDescriptionMetadata.a);
        }
    }
    PrimaryKeyValueDescriptionMetadata.$t = /*@__PURE__*/ markType(PrimaryKeyValueDescriptionMetadata, 'PrimaryKeyValueDescriptionMetadata');
