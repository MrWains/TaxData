...
export let TimeAxisLabelFormatDescriptionMetadata = /*@__PURE__*/ (() => {
    class TimeAxisLabelFormatDescriptionMetadata extends Base {
        ...
        static c(a, b) {
            ...
            b.item("RepeatedYearFormat", "String");
            b.item("RepeatedMonthFormat", "String");
            b.item("RepeatedDayFormat", "String");
        }
        static d(a) {
            TimeAxisLabelFormatDescriptionMetadata.b(a);
            a.q("TimeAxisLabelFormat", () => new TimeAxisLabelFormatDescription());
            a.p("TimeAxisLabelFormat", TimeAxisLabelFormatDescriptionMetadata.a);
        }
    }
    TimeAxisLabelFormatDescriptionMetadata.$t = /*@__PURE__*/ markType(TimeAxisLabelFormatDescriptionMetadata, 'TimeAxisLabelFormatDescriptionMetadata');
