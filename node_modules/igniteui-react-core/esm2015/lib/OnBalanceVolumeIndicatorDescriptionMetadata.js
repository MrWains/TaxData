 ...
 * @hidden
 */
export let OnBalanceVolumeIndicatorDescriptionMetadata = /*@__PURE__*/ (() => {
    class OnBalanceVolumeIndicatorDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("OnBalanceVolumeIndicator", () => new OnBalanceVolumeIndicatorDescription());
            a.p("OnBalanceVolumeIndicator", OnBalanceVolumeIndicatorDescriptionMetadata.a);
        }
    }
    OnBalanceVolumeIndicatorDescriptionMetadata.$t = /*@__PURE__*/ markType(OnBalanceVolumeIndicatorDescriptionMetadata, 'OnBalanceVolumeIndicatorDescriptionMetadata');
