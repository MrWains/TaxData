 ...
 * @hidden
 */
export let TemplateHeaderCellInfoDescriptionMetadata = /*@__PURE__*/ (() => {
    class TemplateHeaderCellInfoDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.q("TemplateHeaderCellInfo", () => new TemplateHeaderCellInfoDescription());
            a.p("TemplateHeaderCellInfo", TemplateHeaderCellInfoDescriptionMetadata.a);
        }
    }
    TemplateHeaderCellInfoDescriptionMetadata.$t = /*@__PURE__*/ markType(TemplateHeaderCellInfoDescriptionMetadata, 'TemplateHeaderCellInfoDescriptionMetadata');
